        ...
        <div class="grid sm:grid-cols-2 lg:grid-cols-3 justify-center gap-6">
            ...
            ?>
                    <div class="max-w-[400px] md:max-w-full">
                        ...
                        <div
                            class="bg-white shadow-md rounded-xl max-w-[380px] mx-auto p-6 -mt-16 relative space-y-2">
                            <h4 class="font-varela font-bold text-lg text-black/75">
                                <a href="<?php echo get_permalink(); ?>">
                                    <?php echo esc_html($product->get_name()); ?>
                                </a>
                            </h4>
                            <p class="font-lato font-normal text-base text-black/60 line-clamp-2">
